...
Title = Label(root, text=" Currency Convertor", fg="green",  bg="lightblue", font=("ubuntu", 15, "italic"))
Title.place(x=170, y=10)

Lable1 = Label(root, text="Enter the Amount to Convert :- ", bg="lightblue", fg="brown", font=("ubuntu", 15, "bold"))
...
footer = Label(root, text="Developed and Designed By DARSHAN N DIVAKAR",bg="lightblue", fg="grey", font=("ubuntu", 15, "bold"))
